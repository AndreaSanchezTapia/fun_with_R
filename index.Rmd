...
+ Calls the 'Cloud Translation' API <https://cloud.google.com/translate/> for detection and translation of text
...
+ Write a small shiny app and learn how it should be included in a package
